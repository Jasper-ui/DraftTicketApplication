...
import com.product.DraftTicketApplication.entities.ValidationErrorResponse;
...
class ValidationExceptionsControllerAdvice {
    ...
    public ResponseEntity<ValidationErrorResponse> handleBindingErrors(MethodArgumentNotValidException ex) {
        ...
        ValidationErrorResponse validationError = new ValidationErrorResponse(HttpStatus.BAD_REQUEST.value(), fieldName, errorMessage);
